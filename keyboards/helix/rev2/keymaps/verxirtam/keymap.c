...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Alt  | GUI  | EISU |Lower |Space |Space |Space |Space |Raise | KANA | Left | Down |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_GRV, KC_BSLS, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_SLSH, \
      ADJUST,  KC_LALT, KC_LGUI, EISU,    LOWER,   KC_SPC,  KC_SPC,  KC_SPC, KC_SPC,  RAISE,   KANA,    KC_LEFT, KC_DOWN, KC_RGHT  \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_GRV,  KC_BSLS, KC_F12,  _______, _______, _______, KC_PGUP, _______, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_TILD, KC_PIPE, KC_F12,  _______, _______, _______, KC_PGUP, _______, \
      _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_END \
      ),
